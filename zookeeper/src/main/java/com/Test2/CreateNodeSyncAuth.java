...
public class CreateNodeSyncAuth implements Watcher { 
	...
	private void doSomething(){
		try {
			...
			ACL aclDigest = new ACL(Perms.READ|Perms.WRITE,new Id("digest",DigestAuthenticationProvider.generateDigest("jiuqiyuliang:123456")));
			ArrayList<ACL> acls = new ArrayList<ACL>();
			acls.add(aclDigest);
			acls.add(aclIp);
			//zookeeper.addAuthInfo("digest", "jiuqiyuliang:123456".getBytes());			
